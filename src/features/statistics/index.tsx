    ...
    <>
      <div className="bg-brown-50 dark:bg-dark-600 text-brown-800 dark:text-dark-100 font-poppins flex h-screen w-full items-start justify-center overflow-y-auto">
        ...
        <section className="mt-20 flex h-fit w-full max-w-5xl flex-col items-center">
          ...
          <section className="bg-brown-100/45 dark:bg-dark-900/45 border-brown-200/75 flex h-full w-5xl flex-col items-center justify-center gap-9 rounded-t-3xl border border-b-0 p-12 dark:border-black">
            {/* Focus heatmap */}
            <DayStreak />
            <FocusHeatmap />
            <OtherStats />
