...
export default function FocusHeatmap() {
  ...
  return (
    <main className="bg-brown-100 corner-scoop dark:bg-dark-900 border-brown-300 shadow-brown-400 relative w-full rounded-xl px-7 pt-8 pb-6 shadow-xs dark:border-black dark:shadow-black">
